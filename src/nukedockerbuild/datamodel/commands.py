    ...
    OperatingSystem.WINDOWS: [
        ...
        DockerCommand(
            [
                ...
                r"MSVCDIR=${{MSVCDIR//\\\\//}}",
                r"MSVCDIR=${{MSVCDIR#z:}}",
                'echo "export BIN=${{BIN}}" >> /etc/bash.bashrc',
                'echo "export MSVCDIR=$MSVCDIR" >> /etc/bash.bashrc',
                'echo "export CC=${{BIN}}cl" >> /etc/bash.bashrc',
                'echo "export CXX=${{BIN}}cl" >> /etc/bash.bashrc',
                'echo "export RC=${{BIN}}rc" >> /etc/bash.bashrc',
                'echo "source /opt/msvc/msvcenv-native.sh" >> /etc/bash.bashrc',
            ]
        ),
    ],
}
